...
arr.forEach((num) => console.log(num.phone));

// create and print a list of website and email pairs (pair them in a string, array, or object)
// let array = [];
// arr.forEach(
//   (arr) => array.push(arr.email))
//   console.log(array);

//   let array2 = [];
// arr.forEach(
//   (arr2) => array2.push(arr2.website))
//   console.log(array2);
// sorry ignore this ^^^^ might have got a little lost at 4 am lol

const newArr = [];
arr.forEach((item) => newArr.push(item.website + item.email)
);
console.log(newArr);
